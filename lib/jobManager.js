...
var JobManager = module.exports = function JobManager(options) {
    ...
    var blockHasher = (function () {
        if (options.coin.algo_block !== undefined) {
            switch (options.coin.algo_block) {
                case 'sha256':
                    return function (d) {
                ...
                default:
                    var hashFunc = algos[options.coin.algo_block].hash(options.coin);
                    return function () {
                        return util.reverseBuffer(hashFunc.apply(this, arguments));
                    };
            }
        } else {
            switch (options.coin.algorithm) {
