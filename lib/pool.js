...
var pool = module.exports = function pool(options, authorizeFn) {
    ...
    if (options.coin.algorithm in algos === false) {
    ...
    function GetBlockTemplate(callback) {
        ...
        _this.daemon.cmd('getblocktemplate', [{"capabilities": [ "coinbasetxn", "workid", "coinbase/append" ], "rules": [ "segwit" ]}],
            function(result) {
    ...
    **/
    ...
    this.relinquishMiners = function(filterFn, resultCback) {
        ...
        async.filter(stratumClients, filterFn,
